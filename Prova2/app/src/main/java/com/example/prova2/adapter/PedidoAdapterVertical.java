...
public class PedidoAdapterVertical extends RecyclerView.Adapter<PedidoAdapterVertical.ViewHolder>{
    private final ArrayList<Produto> lista;
    private final Context context;
    private final PedidoAdapterVertical.ItemClickListener mItemListener;
    private final BDCarrinho bdCarrinho;
    private final String idUsuario;

    public PedidoAdapterVertical(Context c, ArrayList<Produto> l, PedidoAdapterVertical.ItemClickListener itemClickListener, String idUsuario){
        this.context = c;
        this.lista = l;
    ...
    @NonNull
    @Override
    public PedidoAdapterVertical.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.pedido_vertical, parent, false);
        return new PedidoAdapterVertical.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull PedidoAdapterVertical.ViewHolder holder, int position) {
        ...
        holder.getPreco().setText("R$ "+ lista.get(position).getPreco().toString());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            preco = (TextView) itemView.findViewById(R.id.txt_preco_produto_pedido_v);
